...
readonly external_srcs="$(pwd)/../allegro-vdu-ctrl-sw"
readonly external_libs="$external_srcs/bin"
readonly external_includes="$(pwd)/../allegro-vdu-ctrl-sw/include"
readonly external_configs="$(pwd)/../allegro-vdu-ctrl-sw/include/config.h"
