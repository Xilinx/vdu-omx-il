...
ifeq ($(ENABLE_BYPASS), 1)
  MODULE_ENC_SRCS+=$(THIS.module_enc)/device_enc_hardware_bypass.cpp
endif
...
ifeq ($(ENABLE_VCU),0)
  MODULE_ENC_SRCS+=$(THIS.module_enc)/device_enc_software.cpp
endif

ifeq ($(ENABLE_JPEG),1)
    MODULE_ENC_SRCS+=$(THIS.module_enc)/settings_enc_mjpeg.cpp
endif
